...
class ReportsDataTable extends DataTable
{
    ...
    protected function getColumns()
    {
        return [
            ...
            Column::make('kelas')->title(__("reporting::reports.kelas")),
            ...
            Column::make('nomor_hp')->title(__("reporting::reports.nomor_hp"))->hidden(),
            Column::make('alamat')->title(__("reporting::reports.alamat"))->hidden(),
