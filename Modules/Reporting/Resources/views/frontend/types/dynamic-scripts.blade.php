@php
    $status = \Modules\Reporting\Services\ReportService::prepareStatusFilter();
    \Log::debug($status);
...
<script>
    ...
    $(document).ready(function(){
        $(document).on('click', 'button.choose-report', function(e){
            var ele = $(this);  
            var fireAjax = false;
