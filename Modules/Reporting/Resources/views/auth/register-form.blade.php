...
<div class="row">
    <div class="col-md-5">
        <div class="form-group">
            ...
            $field_data_id = 'report_type';
            $field_lable = __("reporting::$module_name.$field_name");
            $field_placeholder = __("Select an option");
            $required = "required";
            $select_options = $report_types;
            ?>
            {{ html()->label($field_lable, $field_name) }} {!! fielf_required($required) !!}
...
<div class="row">
    <div class="col-md-8">
        <div class="form-group">
            <?php
            $field_name = 'report_bank_name';
            $field_data_id = 'report_bank_name';
            $field_lable = __("reporting::$module_name.$field_name");
            $field_placeholder = __("Select an option");
            $required = "required";
...
<div class="row">
    <div class="col-8">
        <div class="form-group">
            <?php
            $field_name = 'report_bank_account';
            $field_lable = __("reporting::$module_name.$field_name");
            $field_placeholder = $field_lable;
            $required = "required";
            ?>
