...
use Modules\Reporting\DataTables\TypesDataTable;
use Modules\Reporting\Http\Requests\Backend\TypesRequest;
...
class TypesController extends Controller
{
    ...
    public function __construct(TypeService $typeService)
    {
        ...
        $this->module_model = "Modules\Reporting\Entities\Type";
    ...
    public function index_list(Request $request)
    {
        ...
        $$module_name = $this->typeService->getIndexList($request);
    ...
    public function show($id)
    {
        ...
        $types = $this->typeService->show($id);
    ...
    public function edit($id)
    {
        ...
        $types = $this->typeService->edit($id);

        $$module_name_singular = $types->data;

        $options = $this->typeService->prepareOptions();
    ...
    public function update(TypesRequest $request, $id)
    {
        ...
        $types = $this->typeService->update($request,$id);
    ...
    public function destroy($id)
    {
        ...
        $types = $this->typeService->destroy($id);
    ...
    public function purge($id)
    {
        ...
        $types = $this->typeService->purge($id);
    ...
    public function trashed()
    {
        ...
        $types = $this->typeService->trashed();

        $$module_name = $types->data;
    ...
    public function restore($id)
    {
        ...
        $types = $this->typeService->restore($id);
    ...
    public function import(Request $request)
    {
        ...
        $types = $this->typeService->import($request);
    ...
    /**
     * FOr getting type data via ajax
     *
     * @return Response
     */
    public function get_type(Request $request)
    {
        ...
        $response = $this->typeService->get_type($request);
